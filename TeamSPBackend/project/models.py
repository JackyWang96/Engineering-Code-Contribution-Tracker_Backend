...
class ProjectCoordinatorRelation(models.Model):
    ...
    git_url = models.CharField(max_length=256, null=False, default="")
    git_backend_url = models.CharField(max_length=256, null=False, default="")
    ...
    git_token = models.CharField(max_length=256, null=False, default="")
